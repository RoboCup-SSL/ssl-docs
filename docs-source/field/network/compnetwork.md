...
The below diagrams show near full instantiations of above general archiecture.
As noted in the legend of the diagrams, some items like IP addresses and VLANs
are examples. In reality IP addresses will be dynamically allocated and will
change thoughout the competition. Other such information is noted in the
legend box.
